...
exports.sendContactsDeletedEmail = async ({ accountId, deletedContacts }) => {
  try {
    ...
    const toEmails = (account.notification_emails || [])
...
<body style="margin:0;padding:0;background:#F2F2F2;font-family:Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="padding:30px 0;">
          ...
          <td style="padding:20px 28px 4px;border-bottom:1px solid #eee;">
            <table width="100%">
              ...
              <tr>
                ...
                <td style="font-size:13px;color:#111;font-weight:600;">${deletedContacts.length} contacto(s)</td>
              </tr>
            </table>
          </td>
        </tr>
    ...
    if (error) {
      ...
      console.log(`✅ Email enviado a ${toEmails.join(", ")} | id: ${data?.id}`);
    }
