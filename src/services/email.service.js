    ...
    htmlContent: `
      ...
      <tr>
        <td style="color:#374151; font-size:15px; line-height:1.6;">
          ...
          <p style="margin-top:16px;">⏱️ <strong>Este código expira en 10 minutos.</strong></p>
          <p>Si no solicitaste este cambio, puedes ignorar este mensaje con seguridad.</p>
        </td>
      </tr>
      <!-- Footer -->
      <tr>
        <td style="border-top:1px solid #e5e7eb; margin-top:24px; padding-top:16px; font-size:13px; color:#6b7280; text-align:center;">
          <p style="margin:0;">© ${new Date().getFullYear()} Chatbot · Soporte técnico</p>
          <p style="margin:4px 0 0;">Este es un correo automático, por favor no respondas.</p>
        </td>
      </tr>
    `,
  });
